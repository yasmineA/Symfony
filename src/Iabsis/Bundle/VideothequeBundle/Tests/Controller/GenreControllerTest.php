...
namespace Iabsis\Bundle\VideothequeBundle\Tests\Controller;
...
class GenreControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'iabsis_bundle_videothequebundle_genre[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Update')->form(array(
            'iabsis_bundle_videothequebundle_genre[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
